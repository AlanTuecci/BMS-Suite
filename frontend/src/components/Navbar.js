...
const Navbar = () => {
  ...
  return (
    <header className="flex flex-wrap md:flex-nowrap z-50 w-full py-7">
      ...
      >
        <div className="md:col-span-3 text-txt_color text-3xl flex justify-start items-center font-bold">BMS Suite</div>

        <div className="hidden md:flex md:col-span-6 justify-center items-center">
          <ul className="flex gap-7">
            <li className="relative py-2 px-2 inline-block text-black focus:outline-none before:absolute before:bottom-0.5 before:start-0 before:-z-[1] before:w-full before:h-1 before:bg-lime-400 dark:text-white">
        ...
        <div className="flex items-center gap-x-2 justify-end md:col-span-3">
          <button
            className="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-3xl bg-transparent border border-txt_color text-txt_color hover:scale-105"
            onClick={() => handleLoginRegisterClick("/login")}
          >
            Log in
          </button>
          <button
            className="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-3xl bg-compblue border border-compblue text-bkgd hover:shadow-2xl hover:shadow-dashboard_shadow hover:scale-105"
